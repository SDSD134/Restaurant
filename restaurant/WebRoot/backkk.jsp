...
<link type="text/css" href="${pageContext.request.contextPath}/css/backstage-css.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsbackstage.js">
    </script>
<body>
	<body>
    ...
    <div class="partright" id="partright">
        ...
        <div class="table_messag" id="table_inquire">
            <div id="ttable " class="table_name">
                <div id="table_img" class="table_img"onclick="showmain()">
                    <img  class="img" src=""><!--桌子地址-->
                </div>
                <div id="table5"  class="table_table">
                    <div id="num" class="table_num">桌子编号：1</div>
                    <div id="tabbleid" class="table_id">桌子类型：3人</div>
        ...
        <div class="tablemain"  id="table_main" style="display: none"><!--桌子信息-->
            <table class="mainone">
                <tr class="rownew">
                    ...
                    <tr class="rownew">
                        <td class="a2" id="a2num">aaa</td>
                <td class="a2" id="a2zhuozizhuangtai">aaa</td>
                <td class="a2" id="a2name">aaa</td>
                        <td class="a2" id="a2order-num">aaa</td>
                        <td class="a2" id="a2all">aaa</td>
        ...
        <div class="costumer_message" id="costumer_message" style="display: none">
            ...
            <div class="costumer_table" id="costumer_tabla" ><!--查询后的得到顾客的信息-->
                <table class="costumer_tab" id="costumer_tab">
                    ...
                    <tr class="row1">
                        <td id="t2id" class="t1">aaa</td>
                        <td id="t2name" class="t1">aaa</td>
                        <td id="t2pas" class="t1">aaa</td>
                        <td id="shanchu1" class="u1" onclick="deleteRow1(this)"><img src="shanchu.png"></td>
        ...
        <div class="order_message" style="display: none">
            <div class="order_inquire">
               用户名:<input type="text"  class="seara" name="duoyangsousuo" id="searchb"><br>
                ...
                <input type="button" class="searchall" name="aootijiao" id="submit1" value="查询">
            </div>
            <div class="order_main">
             <div class="order_table">
                 <table class="userbill">
                     ...
                     <tr class="rowc"><!--食物的种类即个数-->
                         <td class="ro1" id="food1"><nobr>提拉米苏</nobr></td>
                         <td class="ro2" id="price">￥120*3</td>

                     </tr>
                     <tr class="rowc"><!--食物的种类即个数-->
                         <td class="ro1" id="allmoney"><nobr>总价</nobr></td>
                         <td class="ro2" id="doller">￥520</td>
                     </tr>
                     <tr class="rowc"><!--食物的种类即个数-->
            ...
            <div id="menu_inquire" class="menu_inquire">
                ...
                <div class="menu_table" id="menu_tabla" ><!--查询后的得到顾客的信息-->
                    <table class="costumer_tab" id="rowcel">
                        ...
                        <tr class="rowb">
                            <td id="m2id" class="t1" ondblclick="ShowElement(this);chuxian()">aaa</td>
                            <td id="m2name" class="t1" ondblclick="ShowElement(this);chuxian()">aaa</td>
                            <td id="m2pas" class="t1" ondblclick="ShowElement(this);chuxian()">aaa</td>
                            <td id="m2zhuangtai" class="t1" ondblclick="ShowElement(this);chuxian()">aaa</td>
                            <td id="shanchu2" class="b1" onclick="deleteRow0(this)"><img src="shanchu.png"></td>
                            <!--<td id="m2biabji" class="t1" ><img src="index.png"></td>-->
                            <td id="ok" class="newc"><input type="submit" class="new_name1" id="bottom_pickup" name="querentijiao" style="display: none" value="确定" onclick="xiaoshi()"></td>
                        </tr>
        ...
        <div class="boss_message" style="display: none">
            <div class="boss_inquire">
                ...
                <input type="button" class="employ1" id="employ11" name="employtijiao" value="注册" onclick="addagain()">
            </div>
                ...
                <table class="employ_main" id="rowemp">
                    ...
                    <tr  class="emp2">
                        <td class="emp20" id="emp20" ondblclick="ShowElement(this);chuxian0()">aaa</td>
                        <td class="emp20" id="enp21" ondblclick="ShowElement(this);chuxian0()">aa</td>
                        <td class="emp2a" id="emp22"onclick="deleteRow(this)"><img src="shanchu.png"></td>
